...
# Modified version of function 'plot.survfit.JMbayes' of JMbayes package
# to obtain Figure 5, Figure 6 and Figure 7 of the manuscript.
# Auxiliary function for 03_jm_tab_fig.R
